    ...
    function () {
        ...
        if (this.room.name != this.memory.targetRoom) {
            ...
            if (this.room.controller && !this.room.controller.my) {
                ...
                } else if (Memory.rooms[this.room.name].center && this.claimController(this.room.controller) == ERR_NOT_IN_RANGE) {
                    this.moveTo(this.room.controller);
                }
                else {
                    this.say(this.reserveController(this.room.controller))
                }
            }
        }
    };
